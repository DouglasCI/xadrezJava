 ...
 * através de polimorfismo por sobrescricao, seguindo as caracteristicas especificas da peca rei.
 */
package xadrez;
...
public class Rei extends Peca {
    ...
    public int checaMovimento(int linhaOrigem, char colunaOrigem, int linhaDestino, char colunaDestino) {
        ...
        if((difLinha == 0) && (difColuna == 0)) {
            ...
            // A distancia absoluta eh maior que 1 em qualquer sentido
            return 0;
        } else {
            // Movimento com distancia absoluta de no maximo 1 casa em qualquer sentido
            return 1;
        }
    }
}